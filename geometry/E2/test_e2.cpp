...
typedef Circle_E2<MyDouble>       Circle_E2d;
...
void test_circle()
{
    const Point_E2d P1( 1.0, 0.0);
    const Point_E2d P2( 0.0, 1.0);
    const Point_E2d P3(-1.0, 0.0);

    Circle_E2d C(P1, P2, P3);

    assert( Circle_E2d(Point_E2d(0.0, 0.0), 1.0) == C );
}
...
void test_clip_2()
{
    ...
    Point_E2d pnts[] = { Point_E2d(-2,-2),
                         Point_E2d(-2, 2),
                         Point_E2d( 2, 2),
                         Point_E2d( 2,-2) };
    Polygon_E2d poly(pnts+0,pnts+sizeof(pnts)/sizeof(Point_E2d));
    const Point_E2d A(0,0);
    const Point_E2d B(0,1);
    Segment_E2d seg = Segment_E2d(A,B);
    bool b = positive_half_space_clip<Geometry_E2d>(seg, poly);
    assert(b);
    const Point_E2d rslt[] = { Point_E2d(0, -2 ),
                               Point_E2d(-2, -2),
                               Point_E2d(-2, 2 ),
                               Point_E2d(-0, 2 ) };
