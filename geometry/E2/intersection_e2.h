...
#include "geometry/E2/projection_e2.h"
...
template<typename NT>
Point_E2<NT>
intersection(const Line_E2<NT> & line1, const Segment_E2<NT> & seg2)
{
    const Line_E2<NT> l2 = Line_E2<NT>(seg2.source(), seg2.target());
    return intersection(line1, l2);
}

template<typename NT>
Point_E2<NT>
intersection_of_hyperplane_and_segment(const Segment_E2<NT>& seg1, const Segment_E2<NT>& seg2)
{
    const Line_E2<NT> line1 = Line_E2<NT>(seg1.source(), seg1.target());
    return intersection(line1, seg2);
}
