...
#ifndef ROTATIONGROUPWINDOW_H
#define ROTATIONGROUPWINDOW_H
...
#include "rotationgroupdataviewer.h"

class RotationGroupWindow :
    public GlowWindow,
    public GlowIdleReceiver
{
public:
    RotationGroupWindow();
    virtual ~RotationGroupWindow();
...
private:
    RotationGroupDataViewer * myRotationGroupDataViewer;
